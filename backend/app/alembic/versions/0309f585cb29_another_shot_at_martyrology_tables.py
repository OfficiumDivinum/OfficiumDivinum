...
def upgrade():
    ...
    op.create_index(
        op.f("ix_datetable_calendar_date"), "datetable", ["calendar_date"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_martyrologyline_id"), "martyrologyline", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_martyrologyline_prefix"), "martyrologyline", ["prefix"], unique=False
    )
    op.create_index(
        op.f("ix_martyrologyline_suffix"), "martyrologyline", ["suffix"], unique=False
    )
    op.create_index(
        op.f("ix_martyrologyline_title"), "martyrologyline", ["title"], unique=False
    )
    op.create_table(
