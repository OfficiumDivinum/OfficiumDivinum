...
def upgrade():
    ...
    op.drop_table('block')
    op.create_foreign_key(None, 'date_association_table', 'martyrology', ['martyrology_id'], ['id'])
    op.create_foreign_key(None, 'line_association_table', 'martyrology', ['martyrology_id'], ['id'])
    op.create_foreign_key(None, 'line_association_table', 'martyrologyline', ['martyrologyline_id'], ['id'])
